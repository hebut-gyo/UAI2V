...
class Args(BaseModel):
    ...
    tracker_name: str = "cogvideo-uavdt"
    ...
    def parse_args(cls):
        ...
        parser.add_argument("--valid_ids", type=str, nargs="+", default="no")
        ...
        parser.add_argument(
            "--modules_to_save", type=str, nargs="+", default=["cam_mlp"]
        )
        parser.add_argument(
            "--aux_head_enable", type=bool, default=False
        )
        parser.add_argument(
            "--aux_head_lambda", type=float, default=0.01
        )
        parser.add_argument(
            "--mediators_attention_enable", type=bool, default=False
        )
